...
to_highC_FFYield
```
When coupling strength is increased to 0.5, we see a stronger trade-off relationship with even higher predator yields and biomass at lower forage fish fishing mortality. Increasing contour steepness of predator yield indicates the increasing effect of forage fish fishing mortality. As species become more interdependent, forage fish fishing mortality affects predator yield more. More potential predator yield is lost at higher forage fish fishing effort, indicating stronger trade off. However, the effect of predator fishing mortality on forage fish yield, though increased with coupling, remains relatively small. 
